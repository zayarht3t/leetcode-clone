...
export const reverseLinkedList: Problem = {
	...
	problemStatement: `<p class='mt-3 text-white text-lg'>Given the <code>head</code> of a singly linked list, reverse the list, and return <em>the reversed list</em>.</p>
	`,
	examples: [
		{
			id: 0,
	...
	constraints: `<li class='mt-2 text-white'>The number of nodes in the list is the range <code>[0, 5000]</code>.</li>
<li class='mt-2 text-white'><code>-5000 <= Node.val <= 5000</code></li>`,
